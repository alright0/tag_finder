...
<b>Реализация UI для сервиса</b> - добавлено<br>
<b>Генерация документации для созданных методов</b> - добавлено<br> 
<b>Покрытие тестами</b><br>
<b>Любые улучшения которые вы считаете необходимыми</b><br> 
